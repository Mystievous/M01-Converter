...
const InstrumentMap defaultMap = {
    {"M1",
     {
         ...
         {"Guitar/Mallet",
          {"Guitar1", "Guitar2", "E.Guitar", "Sitar1", "Sitar2", "Vibes", "Bell", "Tubular", "BellRing", "Karimba",
           "SynMallet", "DW-Vibe", "DW-Bell"}},
         ...
         {"Brass/Reed",
          {"Flute", "PanFlute", "Bottles", "TenorSax", "Trumpet", "MuteTp", "TubaFlugel", "DoubleReed", "Brass1",
           "Brass2"}},
         ...
         {"Poly Synth",
          {"Universe", "SoftHorn", "SynBrass", "FvWave", "MvWave", "PanWave", "PingWave", "Digital1", "Digital2",
    ...
    {"01/W",
     {
         {"Keyboard",
          {"A.Piano", "SoftEP", "E.Piano", "PianoPad1", "PianoPad2", "SynPiano", "Clav", "Harpsicord", "PercOrgan",
           "Organ1", "Organ2", "Rotary", "GospelOrg", "PipeOrgan1", "PipeOrgan2", "Accordion"}},
         {"Guitar/Mallet",
          {"G.Guitar", "F.Guitar", "HardPick", "E.Guitar", "MuteGuitar", "DistGuitar", "FeedBacker", "Banjo", "Harp",
           "Marimba", "Vibe", "MusicBox", "Gamelan", "DigiBell", "MetalBell", "VS Bell"}},
         {"Bass",
          {"A.Bass1", "A.Bass2", "Fretless", "E.Bass1", "E.Bass2", "E.Bass3", "SlapBass", "SynthBass1", "SynthBass2",
           "TechBass", "BowBowBass", "RezzzzBass", "Residrops"}},
         {"Strings/Pad",
          {"Violin", "Cello", "Pizzicato", "StringEns", "AnaStrings", "Choir", "SoftChoir", "Ahhs", "AirVox",
           "SynVox"}},
         {"Brass/Reed",
          {"Trumpet", "Trombone", "MuteTp", "HardFlute", "TinFlute", "BassonOboe", "Clarinet", "SopranoSax", "AltoSax",
           "BariSax", "Tuba/FrH", "Harmonica", "BrassEns1", "BrassEns2"}},
         {"Lead Synth", {"MonoLead", "MiniLead", "VS 89", "4%Pulse", "SynSine", "Sine"}},
         {"Poly Synth",
          {"RawDeal", "Detune", "EtherBell", "FreshAir", "Ghostly", "Ephemerals", "AliaBass", "UnderWater", "Spectrum1",
           "Spectrum2", "Spectrum3"}},
         {"SE/Other",
          {"Stadium", "Thing", "TriRoll", "Clicker", "Crickets1", "Crickets2", "MagicBell", "IronUp", "Tooter",
           "FluteFX", "Flutter"}},
         {"Hit/Chord",
          {"OrchHit", "VibeHit", "Gong", "Timpani", "OrchPerc", "SynClaves", "SynTom1", "SynTom2", "Zap1", "Zap2",
           "Industry1", "Industry2", "RevThing"}},
         {"Drum Kit",
          {"TotalKit", "RockKit", "DanceKit", "AnalogKit", "HipHopKit", "R&BKit", "BD&SDKit1", "BD&SDKit2", "TomKit",
           "CymbalKit", "PercKit1", "PercKit2", "SEKit"}},
     }},
    {"EX",
     {
         ...
         {"Bass",
          {"E.Bass", "SlapBass", "BoostSaw", "ElectroBs", "DarkBass", "FilterBass", "FatBass", "SawRezBass",
           "SquRezBass", "DiscoBass", "VPMBass1", "VPMBass2", "AttackBass", "AcidDistBs", "DetuneBass", "WobbleBass"}},

         {"Strings/Pad",
          {"Strings", "StrQuartet", "TapeString", "AahChoir", "OohChoir", "VocoderPad", "AnalogStr1", "AnalogStr2",
           "DarkPad", "NoisePad", "AnalogPad", "SquarePad", "5thPad", "OctavePad"}},

         {"Brass/Reed",
          {"Trumpet", "TinWhistle", "TapeFlute", "Shakuhachi", "AltoSax", "TenorSax", "Bagpipe", "BrassEns"}},

         {"Lead Synth",
          {"SoftLead", "UrbanLead", "HiResoLead", "MS20Lead", "OctaveLead", "DriveLead", "RaveLead", "DualSquare",
           "SynWire1", "SynWire2", "SyncLoop", "5thSine", "5thSaw", "5thSquare", "ShortArp"}},

         {"Poly Synth",
          {"DetuneStab", "UnisonStab", "5thStab", "PolyComp", "SquDetune", "VPMBrass", "SynthHorn", "DarkSynth",
           "NoisyComp", "RisingPad", "TremoloSin", "TrillPad", "LPFSweep", "HPFSweep", "WaveSweep", "Palawan"}},

         {"SE/Other",
          {"Applause", "HeartBeat", "GunShot", "CarSFX", "Stream", "Forest", "ShakerLoop", "Noise", "8bitNoise",
           "NoiseShot", "NoiseSplit", "SweepSplit", "SirenUp", "SirenDown", "Modulation", "Signal"}},
...
InstrumentConfig InstrumentHelper::GetInstrumentConfig(const std::string& bankName, const std::string& categoryName,
